...
- About solution of parametric Differential Equations
...
- And Extreme Learning Machines (ELMs)
- Combining ELMs and TFC to form Extreme Theory of Functional Connections
- Modeling a part of the _constrained function_ with NNs, specifically ELMs
- Then, usual Physics loss based training will be performed
